...
The calibrated summary now separates three ingredients on the same embedded grid:
...
in compact form. Their role is to delimit where the qualitative signatures remain
stable on the tested grids.
