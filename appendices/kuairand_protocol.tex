...
This protocol instantiates an ethically motivated logged benchmark on top of
...
\begin{itemize}[leftmargin=*]
  ...
  \item comparison against ADWIN, PageHinkley, KSWIN, and NoDrift.
\end{itemize}
