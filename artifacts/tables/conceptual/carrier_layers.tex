...
\centering
\scriptsize
\caption{Summary rows for the extended and operational carrier regimes. The extended rows compare triangular and i.i.d. mixture carriers across span, while the operational rows compare fixed-$\epsilon$ Sinkhorn across $\epsilon$ on embedded low-intrinsic-dimensional support in ambient dimension eight.}
