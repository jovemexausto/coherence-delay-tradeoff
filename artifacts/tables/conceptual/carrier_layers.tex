...
\caption{Representative rows for the extended and operational finite-sample regimes. The extended rows compare triangular and i.i.d. mixture rates across span, while the operational rows compare fixed-$\epsilon$ Sinkhorn across $\epsilon$ on embedded low-intrinsic-dimensional support.}
