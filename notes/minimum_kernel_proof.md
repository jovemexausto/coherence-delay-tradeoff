...
This note is the consolidated proof narrative for Proposition 3.
It assembles the minimum-kernel carrier argument in one place and turns the current supporting notes into named ingredients of a single theorem.
...
These are exactly the safe-zone assumptions identified in `notes/bahadur_frontier_map.md`.
...
The required input is the triangular-array Bahadur representation described in `notes/bahadur_target.md` and resolved in `notes/bahadur_kiefer_resolution.md`.
...
From `notes/bahadur_kiefer_resolution.md`, under the safe-zone assumptions,
...
The associated constant is a design-effect constant, not a new exponent. The comparison with the i.i.d. mixture benchmark is isolated in `notes/design_effect_lemma.md`.
...
Those belong to later layers or to explicit frontier statements.

## Source map

- `notes/minimum_kernel_proposition.md`: theorem-ready statement.
- `notes/bahadur_target.md`: target Bahadur representation.
- `notes/bahadur_kiefer_resolution.md`: remainder decomposition and rate.
- `notes/design_effect_lemma.md`: constant-level comparison with the i.i.d. mixture benchmark.
- `notes/bahadur_frontier_map.md`: safe zone and failure boundaries.
- `notes/bahadur_residual_target.md`: numerical diagnostics for the remainder term.
