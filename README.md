# Temporal-Validity Horizons for Finite-Memory Distribution Tracking under Drift
...
@software{parreira2026useful_memory_horizon,
  title = {Temporal-Validity Horizons for Finite-Memory Distribution Tracking under Drift},
