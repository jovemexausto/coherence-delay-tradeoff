# Useful Memory Horizon: Temporal Validity of Retained Evidence under Drift
...
@software{parreira2026useful_memory_horizon,
  title = {Useful Memory Horizon: Temporal Validity of Retained Evidence under Drift},
