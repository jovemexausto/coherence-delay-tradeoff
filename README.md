# Useful Memory Horizons: Temporal Validity of Retained Evidence under Drift
...
@software{parreira2026useful_memory_horizon,
  title = {Useful Memory Horizons: Temporal Validity of Retained Evidence under Drift},
