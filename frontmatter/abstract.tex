\begin{abstract}
Finite-memory tracking under drift faces a basic tension: retaining more past
information reduces statistical noise, but it also pushes the estimate further
away from the present. As the target distribution moves, each additional sample
becomes at once useful and increasingly old, so the problem is not simply how
much to remember, but how long remembered evidence should remain operationally
current.
