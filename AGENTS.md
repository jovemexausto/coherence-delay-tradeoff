...
- Related-work anchoring is now clearer: raw empirical-Wasserstein finite-sample claims should be positioned through `Fournier-Guillin (2015)` and `Weed-Bach (2019)`, with `Boissard-Le Gouic (2014)` as an earlier low-complexity bridge; entropic operational geometry should be anchored separately through `Genevay et al. (2019)`, `Mena-Niles-Weed (2019)`, `del Barrio et al. (2023)`, `Rigollet-Stromme (2025)`, `Stromme`, and `Groppe-Hundrieser`, while keeping conjectural Sinkhorn inheritance distinct from theorem-level raw-`W_2` claims.
- Projection-based alternatives now need a distinct related-work frame: sliced / max-sliced / subspace-robust / projection-robust OT should be cited as alternative metric geometries or proxy estimators with their own finite-sample behavior, not as automatic improvements for raw `W_2`; the clean anchors are `Kolouri et al. (2018)`, `Deshpande et al. (2019)`, `Paty-Cuturi (2019)`, `Lin et al. (2020)`, `Nadjahi et al. (2020)`, and `Nietert et al. (2022)`.
- Related-work anchoring is now clearer: raw empirical-Wasserstein finite-sample claims should be positioned through `Fournier-Guillin (2015)` and `Weed-Bach (2019)`, with `Boissard-Le Gouic (2014)` as an earlier low-complexity bridge; entropic operational geometry should be anchored separately through `Genevay et al. (2019)`, `Mena-Niles-Weed (2019)`, `del Barrio et al. (2023)`, `Stromme`, and `Groppe-Hundrieser`, while keeping conjectural Sinkhorn inheritance distinct from theorem-level raw-`W_2` claims.
- The entropic-OT literature map is now sharper for writing purposes: `Genevay/Mena/del Barrio/Rigollet-Stromme` cover closed iid sample-complexity and limit theory, `Stromme` plus `Groppe-Hundrieser` cover intrinsic/lower-complexity adaptation, and `Eckstein-Nutz` plus `Ghosal-Nutz-Bernton` provide algorithmic and measure-stability ingredients; none yet proves a drifted triangular-array horizon law with joint sampling, staleness, and optimization control.
- Projection-based alternatives now need a distinct related-work frame: sliced / max-sliced / subspace-robust / projection-robust OT should be cited as alternative metric geometries or proxy estimators with their own finite-sample behavior, not as automatic improvements for raw `W_2`; the clean anchors are `Kolouri et al. (2019)`, `Deshpande et al. (2019)`, `Paty-Cuturi (2019)`, `Lin et al. (2020)`, `Nadjahi et al. (2019, 2020)`, and `Nietert et al. (2022)`.
