...
\begin{lemma}[Auxiliary decomposition principle]\label{thm:abstract_upper_law}
...
of the problem and not an estimator artifact. The Gaussian location theorem
below closes the corresponding benchmark model.
