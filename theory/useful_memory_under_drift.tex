...
do not replace a general verification theorem, but they now sit behind an
explicit sufficient-condition corollary on the smooth deformation class and
quantify span dependence on the classes currently used in the manuscript.
...
\subsection{Multivariate Extension via Sliced and Product Geometries}
...
\]
Coordinate-averaged product constructions are included as the special case in
which $\rho$ is supported on coordinate projections.
\end{corollary}
