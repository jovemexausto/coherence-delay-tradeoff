...
\subsection{Gaussian Benchmark Geometry}
...
The main line above is stated for uniform windows, but the same decomposition
extends to non-uniform lag weights. For a finite-memory estimator with weights
$w_0,\dots,w_{n-1}$, define the effective sample size
\[
