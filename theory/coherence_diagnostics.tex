...
The coherence-lag law constrains the representation term of the finite-memory
...
In the experiments, the same constant is calibrated once per regime; its value
changes with dimension and regularization, but the cube-root exponents do not.
\end{proposition}
