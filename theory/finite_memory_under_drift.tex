...
staleness accumulates, and the Lipschitz case is the $H=1$ anchor inside that
family.
...
\]
In particular, $H=1$ recovers the cube-root anchor.
\end{proposition}
...
This proposition is the roughness-indexed completion of the Lipschitz case.
...
\subsection{Worst-Case Lipschitz Anchor}
...
case is the $H=1$ anchor inside the same family.
...
Lipschitz anchor, the cube-root horizon marks the point where that exchange
