...
instantiation. Two broader settings matter for scope: a Gaussian benchmark in
which the law is closed on a full path class, and an operational Sinkhorn regime
in which some structural ingredients are closed but the full inheritance theorem
remains conjectural.
...
The manuscript does not prove that theorem in full generality. What is closed is
the structural part of the setup. What remains open is the full triangular-array
...
agreement is not uniform across the tested roughness levels. What remains open
beyond \cref{prop:pointwise_sinkhorn_1d} is the genuinely operational step:
uniform control across a nontrivial $\varepsilon$-band and higher-dimensional
embedded classes.
...
Regular dominated families are the natural theorem targets. Support-changing and
