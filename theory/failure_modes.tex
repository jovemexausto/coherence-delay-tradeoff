...
failure regimes that matter empirically. The three failure modes that recur
throughout the experiments feed directly into the coherence scores. The aim is
not to enumerate every possible pathology of an adaptive system, but to isolate
the three ways in which representation, actuation, and adaptation can fail in
...
These failure modes motivate the score construction that follows. Once the three
ways of failing are separated, the natural diagnostic question is how to
summarize them in a single quantity without losing the identity of the active
bottleneck.
