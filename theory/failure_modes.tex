...
The decomposition $(\Pot,\Act,\Conv)$ is useful only if it identifies
failure regimes that matter empirically. This section records the three
diagnostic failure modes used throughout the experiments and the coherence
scores.
