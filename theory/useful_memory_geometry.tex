...
finite-memory estimator. Short windows have small age but large variance;
long windows have small variance but large age. The cube-root horizon marks the
point where the marginal gain from lowering variance no longer compensates for
the additional age of the retained evidence.
